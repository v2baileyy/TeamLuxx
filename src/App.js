  ...
  return (
    <div className="min-h-screen bg-[#030014] text-white font-rajdhani selection:bg-[#22D3EE] selection:text-[#030014]">
      ...
      <style>{`
        ...
        .particle { position: absolute; background: #22D3EE; border-radius: 50%; pointer-events: none; animation: float 5s infinite ease-in-out; }
        .glass-panel { background: rgba(7,5,20,0.8); backdrop-filter: blur(12px); border: 1px solid rgba(26,28,41,1); }
        @keyframes slideDown { from { opacity: 0; transform: translateY(-12px); } to { opacity: 1; transform: translateY(0); } }
        .mobile-menu-enter { animation: slideDown 0.25s ease forwards; }
      `}</style>
                ...
                >
                  ...
                  {member.livePlatform === "tiktok" ? (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center justify-center gap-2 w-full py-3 bg-[#22D3EE] hover:bg-[#1bb8d1] text-[#030014] font-rajdhani font-bold rounded-lg transition-colors"
                    >
                      <Video className="w-5 h-5" /> WATCH TIKTOK
                    </a>
                  ) : (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center justify-center gap-2 w-full py-3 bg-[#9146FF] hover:bg-[#a970ff] text-white font-rajdhani font-bold rounded-lg transition-colors"
                    >
                      <Twitch className="w-5 h-5" /> WATCH TWITCH
                    </a>
                  )}
                </div>
              ))}
              ...
              {[...Array(2)].map((_, i) => (
                <div key={i} className="flex items-center gap-12 px-6">
                  {[
                    ...
                    <span
                      key={idx}
                      className="text-4xl md:text-6xl font-orbitron font-black text-transparent"
                      style={{
            ...
            <div className="relative z-10">
              ...
              <div className="grid md:grid-cols-2 gap-12 items-start">
                <div className="flex flex-col gap-5">
                  {[
                    { href: "https://tiktok.com/@lolitsphe", name: "DM Phe" },
                    {
